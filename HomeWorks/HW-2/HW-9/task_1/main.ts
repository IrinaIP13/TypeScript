...
//
// – створити блок,
const div_91:HTMLDivElement = document.createElement("div");
...
const body_91:HTMLBodyElement = document.getElementsByTagName('body')[0];
// const body_91:HTMLBodyElement | null = document.querySelector('body');
body_91.appendChild(div_91);
//
// – клонувати його повністю, та додати клон в body.
const cloneDiv:Node = div_91.cloneNode(true);
